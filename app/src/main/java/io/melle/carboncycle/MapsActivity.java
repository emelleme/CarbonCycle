...
import io.melle.carboncycle.LocationService;
...
public class MapsActivity extends FragmentActivity implements
    ...
    public void getAddress(View v) {
        ...
        if (servicesConnected()) {
            ...
            (new MapsActivity.GetAddressTask(this)).execute(currentLocation);
        }
    }
    ...
    public void onLocationChanged(Location location) {
        LocationUtils.CURRENTLOCATION = new LatLng(location.getLatitude(),location.getLongitude());
    ...
    private void startPeriodicUpdates() {
        ...
        extras.putString(LocationService.FIREBASE_REF,
                "https://carboncycle.firebaseio.com/location/guru.json");
    ...
    private void setUpMap() {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(LocationUtils.PHILLY, 15));
    }
    ...
    CameraPosition cameraPosition = new CameraPosition.Builder()
        .target(LocationUtils.CURRENTLOCATION)      // Sets the center of the map to Mountain View
        .zoom(17)                   // Sets the zoom
